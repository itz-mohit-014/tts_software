...
if __name__ == "__main__":
    ...
    with gr.Blocks(title=os.environ.get("APP_NAME", "Gradio")) as demo:
        ...
        with gr.Tab("2 - Fine-tuning XTTS Encoder"):
            ...
            # new updated line ...
            console_output = gr.Textbox(label="Console Output", lines=10, interactive=False)
            ...
            def train_model_with_log_capture(*args):
                logger = StreamToTextbox()
                sys.stdout = logger
                sys.stderr = logger
        ...
        with gr.Tab("3 - Inference"):
            with gr.Row():
                ...
                with gr.Column() as col2:
                    ...
                    tts_text = gr.Textbox(
                        label="Input Text.",
                        value="""Jacob stood nervously at the crowded café, clutching a folded letter in his pocket. Ten years since he’d left the city, ten years since he’d last seen Maya.

She walked in, radiant as ever, her eyes scanning the room until they locked with his. Time seemed to pause.

“I wasn’t sure you’d come,” she said, voice barely above a whisper.

“I had to,” Jacob replied, swallowing the lump in his throat. “There’s so much to say.”

They talked for hours—about dreams lost and found, mistakes made, and the road ahead.

As the sun dipped low, Jacob realized some bonds withstand time and distance.

And sometimes, a second chance is all you need.""",
                        lines=10  
                    )
                ...
                with gr.Column() as col3:
                    ...
                    reference_audio = gr.Audio(label="Reference audio used.", visible=False)
...
# /new upldate code start ****
            train_btn.click(
                fn=train_model_with_log_capture,
                inputs=[
                    custom_model,
                    version,
                    lang,
